...
import com.example.demo.export.PaymentPDFExporter;
...
public class PaymentController {
	...
	@RequestMapping(value = "/saveeditp", method = RequestMethod.POST)
	public String saveeditedPayment(@ModelAttribute("payment") Payment payment) {
	    service.save(payment);
	...
	public ModelAndView home() {
	 ...
	 @GetMapping("/payments/export/pdf")
	    public void exportToPDF(HttpServletResponse response,Model model,@Param("startdate") Date startdate,@Param("enddate") Date enddate) throws DocumentException, IOException {
	        response.setContentType("application/pdf");
	        Date currentDateTime = new Date(System.currentTimeMillis());
	         
	        String headerKey = "Content-Disposition";
	        String headerValue = "attachment; filename=MonthlyIncome_" + currentDateTime + ".pdf";
	        response.setHeader(headerKey, headerValue);
	         
	        List<Payment> listPaymentDate = service.listAllByDate(startdate, enddate);
	        List<Payment> monthlylistPayments = service.listAllByDate(startdate, enddate);
			model.addAttribute("monthlylistPayments", monthlylistPayments);
			model.addAttribute("startdate", startdate);
			model.addAttribute("enddate", enddate);
	         
	        PaymentPDFExporter exporter = new PaymentPDFExporter(listPaymentDate);
